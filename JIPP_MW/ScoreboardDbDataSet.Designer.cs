...
namespace JIPP_MW {
    ...
    public partial class ScoreboardDbDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public TableRow AddTableRow(string Nick, long Time) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Nick {
                get {
                    return ((string)(this[this.tableTable.NickColumn]));
                }
                set {
                    this[this.tableTable.NickColumn] = value;
                }
            }
            ...
            public long Time {
                get {
                    return ((long)(this[this.tableTable.TimeColumn]));
                }
                set {
...
namespace JIPP_MW.ScoreboardDbDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Nick] = @Original_Ni" +
                "ck) AND ([Time] = @Original_Time))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Nick], [Time]) VALUES (@Nick, @Time);\r\nSELECT Id, Nic" +
                "k, Time FROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Nick] = @Nick, [Time] = @Time WHERE (([Id] = @Original_" +
                "Id) AND ([Nick] = @Original_Nick) AND ([Time] = @Original_Time));\r\nSELECT Id, Ni" +
                "ck, Time FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::JIPP_MW.Properties.Settings.Default.ScoreboardDbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nick, Time FROM dbo.[Table]";
        ...
        public virtual int Fill(ScoreboardDbDataSet.TableDataTable dataTable) {
        ...
        public virtual ScoreboardDbDataSet.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ScoreboardDbDataSet.TableDataTable dataTable = new ScoreboardDbDataSet.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ScoreboardDbDataSet.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nick, System.TimeSpan Original_Time) {
        ...
        public virtual int Insert(string Nick, System.TimeSpan Time) {
            if ((Nick == null)) {
        ...
        public virtual int Update(string Nick, System.TimeSpan Time, int Original_Id, string Original_Nick, System.TimeSpan Original_Time, int Id) {
            if ((Nick == null)) {
                throw new global::System.ArgumentNullException("Nick");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nick, System.TimeSpan Time, int Original_Id, string Original_Nick, System.TimeSpan Original_Time) {
            return this.Update(Nick, Time, Original_Id, Original_Nick, Original_Time, Original_Id);
        }
    }
